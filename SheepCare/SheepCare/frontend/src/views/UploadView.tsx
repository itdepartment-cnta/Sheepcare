...
import { farmsApi, uploadsApi } from '../api';
import type { Farm, UploadResult } from '../api';
...
export default function UploadView() {
    ...
    return (
        <div>
            ...
            <p className="text-gray-500 mb-8">Sube archivos Excel (.xlsx) o CSV con datos de resistencia de animales.</p>
            ...
            {/* Results */}
            {result && (
                <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm max-w-2xl mt-6">
                    <div className="flex items-center gap-2 mb-4">
                        <CheckCircle size={20} className="text-acido" />
                        <h2 className="text-lg font-semibold text-grafito">Procesamiento Completado</h2>
                    </div>
                    ...
                    <h3 className="font-semibold text-sm text-gray-500 mb-3 uppercase tracking-wide">Resultados por Animal</h3>
